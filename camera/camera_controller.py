...
#Client initializing 
def initialize(id, camera, host, port=1883, server_tls=False, server_cert=None):
...
if __name__ == "__main__":
    camera = Camera()
    client = initialize(camera.get_name(), camera, "192.168.1.1", 8883, True, "../ca_certificates/ca.crt")
    client.loop_start()
